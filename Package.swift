...
let package = Package(
    ...
    products: [
        ...
        .library(name: "BlueskyNotifications", targets: ["BlueskyNotifications"]),
        .library(name: "BlueskyMessages", targets: ["BlueskyMessages"]),
        ...
        .library(name: "BlueskyOnboarding", targets: ["BlueskyOnboarding"]),
    ],
    targets: [
        ...
        .testTarget(
            ...
            dependencies: ["BlueskyKit", "BlueskyCore", "BlueskyDataStore", "BlueskyNotifications", "BlueskyComposer", "BlueskyModeration", "BlueskyLists"]
        ),
    ],
